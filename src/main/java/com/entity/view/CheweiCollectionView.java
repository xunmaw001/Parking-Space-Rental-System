...
public class CheweiCollectionView extends CheweiCollectionEntity implements Serializable {
	...
	*/
	...
	private String cheweiCollectionValue;
	...
	* 获取： 类型的值
	*/
	public String getCheweiCollectionValue() {
		return cheweiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setCheweiCollectionValue(String cheweiCollectionValue) {
		this.cheweiCollectionValue = cheweiCollectionValue;
	}
	...
	public String toString() {
		return "CheweiCollectionView{" +
			", cheweiCollectionValue=" + cheweiCollectionValue +
