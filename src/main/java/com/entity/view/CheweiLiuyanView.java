...
public class CheweiLiuyanView extends CheweiLiuyanEntity implements Serializable {
	...
	public CheweiLiuyanView() {

	}

	public CheweiLiuyanView(CheweiLiuyanEntity cheweiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, cheweiLiuyanEntity);
