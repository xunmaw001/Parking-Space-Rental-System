...
var centerMenu = [
    ...
    ,{
        name: '车位收藏',
        url: '../cheweiCollection/list.html'
    }
    ,{
        name: '车位租赁订单',
        url: '../cheweiZulin/list.html'
    }
    ,{
        name: '车位预约',
        url: '../cheweiyuyue/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/cheweizulinxitong/admin/dist/index.html#/login";
